...
def split__data(comp_data):
    ...
    return comp_sets_by_id, comp_sets_by_family
...
def export_to_excel(xls_wb, state, year, exam_category, username, password):
    ...
    comp_sets_by_id, comp_sets_by_family = split__data(comp_data_raw)
    ...
    ws_ids = wb.add_worksheet("ids")
    row = 0
    ws_ids.set_column(0, 0, 90)
    ws_ids.set_column(1, 1, 90)
    ...
    # setting up index tags
    ws_family = wb.add_worksheet("family list")
