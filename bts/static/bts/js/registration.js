    ...
    <div id='+ student_str+'">\
        ...
        <div  class="row">\
            <div class=col-md-6>\
                ...
                <input id="'+ student_str +'_surname_tamil" class="'+page+'" name="'+student_str+'_surname_tamil" placeholder="Surname (Tamil)" tabindex="1" type="text" required>\
            </div>\
            <div class=col-md-6>\
                <p class="form-label"><label for="'+ student_str +'_givenname_tamil">Gieven Name (Tamil) </label></p>\
                <input id="'+ student_str +'_givenname_tamil" class="'+page+'" name="'+student_str+'_givenname_tamil" placeholder="Given Name (Tamil)" tabindex="1" type="text" required>\
            </div>\
        </div>\
        <div  class="row">\
            <div class=col-md-6>\
